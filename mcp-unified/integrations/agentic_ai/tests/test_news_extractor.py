#!/usr/bin/env python3
"""
Test Script untuk NewsExtractor
"""
...
async def test_news():
    """Test scraping dari website berita"""
    
    # URL berita - CNN Indonesia (umumnya accessible)
    NEWS_URL = "https://www.cnnindonesia.com/nasional"
    DOMAIN = "berita"
    TAGS = ["news", "cnn", "nasional", "test"]
    
    print("🚀 NewsExtractor Web Scraping Test")
    print("=" * 60)
    print()
    print(f"📋 Konfigurasi:")
    ...
    try:
        ...
        if result['success']:
            ...
            # Save to file
            filename = f"news_result_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
            try:
            ...
            print("   3. Coba dengan URL berita yang berbeda")
