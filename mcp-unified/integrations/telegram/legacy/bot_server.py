...
Runtime bot Telegram utama sekarang menggunakan `run.py` + `bot.py`
dengan pemisahan tegas antara chat Telegram, bridge agent, dan service SQL.
"""
import asyncio
import json
import logging
...
sys.path.insert(0, str(PARENT_DIR / "services"))
