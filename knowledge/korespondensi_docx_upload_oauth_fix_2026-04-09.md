...
- Script sumber utama: `korespondensi-server/src/web_app.py`
- Modul upload: `korespondensi-server/src/services/sync_service.py`
- Endpoint validasi: `POST /api/disposisi/generate/0327_000.4.2_834_bu_set`
...
- Jika perlu, tambahkan juga nama command/flow yang dipakai untuk menghasilkan
  token OAuth baru sebagai bagian dari jejak audit.
